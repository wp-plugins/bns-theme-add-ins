...
These functions make use of the (Child-)Theme name to preface menu items and for the `textdomain` where appropriate so it appear the Theme itself is providing the functionality.

Q: Where can I get support for this plugin?
A: Feel free to visit the plugin's home page: http://buynowshop.com/plugins/bns-theme-add-ins/ and leave a comment; or, feel free to use the Contact Us form here: http://BuyNowShop.com/contact-us/  
